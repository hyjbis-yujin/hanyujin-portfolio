...
프로덕트 디자이너 한유진의 개인 포트폴리오 사이트입니다. 이력서만으로는 전달하기 어려운 작업 과정과 화면을 직접 보여주기 위해 만들었습니다.

홈·소개·스킬·커리어·프로젝트·컨택트 여섯 개 섹션을 풀페이지 스냅 스크롤로 연결했고, 프로젝트는 카드를 누르면 모달에서 작업 내용과 화면을 확인할 수 있습니다. 디자인부터 퍼블리싱, 배포까지 직접 진행했습니다.
